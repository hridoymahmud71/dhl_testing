...
class Dhl_model extends CI_Model
{
	...
	{
		$this->set_mode()->set_test_mode()->set_api_user_and_password()->set_other_live_credentials()->set_credentials();
		return $this;
	}
	...
	{
		$this->test_mode = $this->get_mode() == Credentials::TEST_NORMAL ? Credentials::TEST_NORMAL : false;
		return $this;
	}
	...
	public function set_api_user_and_password()
	{
		...
		$this->set_api_user()->set_api_password();
	...
	{
		$credentials = new Credentials($this->get_test_mode());

		//	On test:  Set the USERNAME (not E-Mail!) of your DHL-Dev-Account
		//	On live:  Your Applications-ID (You can find it in your DHL-Dev-Account)
		$credentials->setApiUser($this->api_user);

		//	On Test: Set the Password of your DHL-Dev-Account
		//	On live: Your Applications-Token (You can find it also where you found the App-Id)
		$credentials->setApiPassword($this->api_password);
	...
	{
		$credentials = $this->get_credentials();
		$dhl = new BusinessShipment($credentials, $this->get_test_mode(), self::API_VERSION);
		return $dhl;
	}
