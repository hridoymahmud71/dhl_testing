...
// Set your API-Login
		$credentials->setApiUser(DDAU);           // Test-Mode: Your DHL-Dev-Account (Developer-ID NOT E-Mail!!) | Production: Your Applications-ID
		$credentials->setApiPassword(DDAP);       // Test-Mode: Your DHL-Dev-Account Password | Production: Your Applications-Token
...
// Required just Credentials also accept Test-Mode and Version
		$dhl = new BusinessShipment($credentials, /*Optional*/
			$testMode, /*Optional*/
			$version);
